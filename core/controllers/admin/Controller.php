...
class Admin extends Controller {
    ...
    protected function isAdminLogin($namespace='admin', $controller=null) {
	    if (xiaocms::get_namespace_id() != $namespace) return false;
        if ($controller && xiaocms::get_controller_id() != $controller) return false;
        if (xiaocms::get_namespace_id() == 'admin' && xiaocms::get_controller_id() == 'login') return false;
