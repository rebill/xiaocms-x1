...
return array(
    ...
    '^([a-zA-Z0-9]+)[/]?$'          => 'c=index&a=list&catdir=${1}',
    '^([a-zA-Z0-9]+)/([0-9]+)[/]?$' => 'c=index&a=list&catdir=${1}&page=${2}',

    //内容: http://网站/内容id.html 分页: http://网站/栏目目录/内容id-分页id.html
    '^([a-zA-Z0-9]+)/([0-9]+).html$'           => 'c=index&a=show&id=${2}',
    '^([a-zA-Z0-9]+)/([0-9]+)\-([0-9]+).html$' => 'c=index&a=show&id=${2}&page=${3}',
